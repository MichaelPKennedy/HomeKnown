...
export declare const weatherAdditionalQueryProperties: import("@sinclair/typebox").TObject<{
    ...
    temperatureData: import("@sinclair/typebox").TArray<import("@sinclair/typebox").TObject<{
        month: import("@sinclair/typebox").TString<string>;
        temp: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TNumber>;
    }>>;
}>;
