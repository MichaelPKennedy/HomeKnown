...
export declare const weatherQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TPartial<import("@sinclair/typebox").TObject<{
    ...
    temperaturePreference: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TLiteral<"mild">, import("@sinclair/typebox").TLiteral<"distinct">]>>;
    climatePreference: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TLiteral<"warmer">, import("@sinclair/typebox").TLiteral<"cooler">]>>;
    snowPreference: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TLiteral<"none">, import("@sinclair/typebox").TLiteral<"light">, import("@sinclair/typebox").TLiteral<"heavy">]>>;
    rainPreference: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TLiteral<"dry">, import("@sinclair/typebox").TLiteral<"regular">]>>;
    importantSeason: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TLiteral<"winter">, import("@sinclair/typebox").TLiteral<"summer">, import("@sinclair/typebox").TLiteral<"spring">, import("@sinclair/typebox").TLiteral<"fall">]>>;
    seasonPreferenceDetail: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TLiteral<"mildWinter">, import("@sinclair/typebox").TLiteral<"coldWinter">, import("@sinclair/typebox").TLiteral<"snowyWinter">, import("@sinclair/typebox").TLiteral<"mildSummer">, import("@sinclair/typebox").TLiteral<"hotSummer">, import("@sinclair/typebox").TLiteral<"drySummer">, import("@sinclair/typebox").TLiteral<"warmSpring">, import("@sinclair/typebox").TLiteral<"coolSpring">, import("@sinclair/typebox").TLiteral<"drySpring">, import("@sinclair/typebox").TLiteral<"warmFall">, import("@sinclair/typebox").TLiteral<"coolFall">, import("@sinclair/typebox").TLiteral<"dryFall">]>>;
}>]>;
